      ...
      <div className="container mx-auto px-4 max-w-[1400px] relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center py-2">
          ...
          <div className="space-y-4 pt-2">
            ...
            >
              <Link href="tel:7012740820" className="bg-[#4ADE80] hover:bg-[#22C55E] text-primary rounded-xl px-6 h-14 flex items-center justify-center shadow-[0_0_15px_rgba(74,222,128,0.3)] group transition-all">
